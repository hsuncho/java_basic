...
//		run type exception
		...
		//7. 배열 대부의 요소값을 문자열 형태로 한눈에 출력하기
		...
		System.out.println(Arrays.toString(booArr));//false
		...
		//선언과 동시에 초기화를 할 때
		//딱 1번만 가능한 문법
		//자바에서의 배열은 크기가 고정이기 때문에 늘어나거나 줄어들 수 없다
