...
//		User u1 = new User("홍길동", 16);
//		User u2 = new User("김영희", 30);
//		User u3 = new User("박철수", 44);
//		
//		Collections.addAll(userList, u1, u2, u3);
		
//		userList.add(new User("홍길동", 16));
//		userList.add(new User("김영희", 30));
//		userList.add(new User("박철수", 44));
        ...
        */
		...
		//향상 for문 안에서는 list의 크기를 늘리거나 줄이면
		//특정 인덱스를 건너뛰면서 에러 발생(break 걸면 에러 발생 방지 가능)
//		for(User user: userList) {
//			if(user.getName().equals("홍길동")) {
//				userList.remove(user);
//				System.out.println("삭제 후 정보: "+userList);
//				break;
//			}
//		}
