...
public class MyBirth {
	...
	/*
	 ...
	 oop(object oriented program) 기술 중 하나 
    ...
    */
	...
	public void birthInfo() {
		...
		if(getYear("aaa1111!")!=0 && getMonth()!=0 && getDay()!=0) {
			System.out.printf("내 생일은 %d년 %d월 %d일 입니다.\n", getYear("aaa1111!"),getMonth(), getDay());
		} else return;
...
//			} else this.day = day;
	...
	/*
	 - 데이터와 데이터를 다루는 여럭지 메서드들을 하나로 묶는 이러한 행위들을
	 캡슐화라고 합니다.(encapsulation)
	 데이터와 그 데이터를 다루는 로직을 하나로 묶어 쉽게 관리하고 유지보수하기 위함입니다.
	 */
