...
public class ArrayInsert {
	...
	public static void main(String[] args) {
        ...
        */
		...
		Person[] peopArr = new Person[3];
		for(int i =0; i<peopArr.length;i++) {
			...
			peopArr[i] = new Person(name, age, gender);
			
			System.out.println("*** 정보 입력 완료 ***\n");
		} //입력받는 반복문 끝
		
//		System.out.println(Arrays.toString(peopArr));
		
		System.out.println("-----------------");
		for(Person p:peopArr) {
			p.personInfo(); 
		}
		sc.close();
	}
